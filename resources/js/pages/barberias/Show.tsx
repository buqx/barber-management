    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6 max-w-2xl">
                <PageHeader title={barberia.nombre} backRoute="/barberias" />
                <Card>
                    <CardHeader>
                    ...
                    <CardContent className="grid gap-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <InfoField label="Booking" value={barberia.booking_habilitado ? 'Habilitado' : 'Deshabilitado'} />
                        </div>
                        <Separator />
                        <div className="flex gap-2">
                            <Button onClick={() => router.visit(`/barberias/${barberia.id}/edit`)}>
                                Editar
                            </Button>
